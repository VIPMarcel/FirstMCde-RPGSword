...
public record CoinShopCommand(RPGSword plugin) implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] arguments) {
        ...
        if(sender instanceof Player player) {
            ...
            player.openInventory(this.plugin.getInventoryManager().getInventory(InventoryType.SHOP_MENU, player));
